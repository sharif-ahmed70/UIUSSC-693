  ...
  return (
    <div>
      ...
      <section className="mb-6 rounded-md border border-amber-200 bg-amber-50 p-5 text-amber-900">
        <h2 className="font-extrabold">First super admin required</h2>
        <p className="mt-2 text-sm leading-6">This page remains inaccessible until a trusted operator bootstraps one real approved volunteer as super admin.</p>
      </section>

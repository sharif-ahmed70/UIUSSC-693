    ...
    <section className="landing-section">
      <div className="mx-auto grid max-w-6xl gap-8 px-4 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <div>
          ...
          <h2 className="font-display mt-4 text-3xl font-bold leading-tight text-uiussc-charcoal md:text-4xl">Students Serving Communities With Purpose</h2>
        ...
        <div className="grid gap-4 sm:grid-cols-[1fr_0.9fr]">
          <SafeImage src={image?.imageUrl} alt={image?.caption || 'UIUSSC volunteers working together'} className="min-h-64 rounded-2xl" />

  ...
  return (
    <section className="landing-section bg-uiussc-neutral">
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
        ...
        <h2 className="font-display mt-4 text-3xl font-bold leading-tight text-uiussc-charcoal md:text-4xl">Ready to Serve, Lead, and Make a Difference?</h2>
        <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-uiussc-muted">

import AnimatedMetricValue from '@/components/home/AnimatedMetricValue'
  ...
  return (
    <section className="relative z-10 mx-auto -mt-16 max-w-6xl px-4 sm:px-6">
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        {metrics.map((metric) => (
          <article key={metric.label} className="home-card min-h-36 p-5 transition duration-200 hover:-translate-y-1 hover:shadow-2xl">
            <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-uiussc-green/10 text-uiussc-green" aria-hidden="true">
            ...
            <div className="text-3xl font-black text-uiussc-charcoal"><AnimatedMetricValue value={metric.value} /></div>

  ...
  return (
    <section className="landing-section bg-uiussc-neutral">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <h2 className="font-display mt-4 text-3xl font-bold text-uiussc-charcoal md:text-4xl">Our Areas of Service</h2>
        <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {serviceAreas.map((area) => {
            const count = area.category ? categoryCounts[area.category] : undefined
            return (
              <Link key={area.title} href="/events" className="group rounded-2xl border border-[rgba(21,19,18,0.10)] bg-white p-5 transition hover:-translate-y-1 hover:shadow-xl">
                <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-full bg-uiussc-orange/10 text-uiussc-orange">
                ...
                <h3 className="text-lg font-extrabold text-uiussc-charcoal">{area.title}</h3>

...
export default function MetricsCards({ metrics }: { metrics: VolunteerMetrics }){
  ...
  return (
    <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <article className="rounded-md border border-emerald-200 bg-emerald-50 p-4 xl:col-span-2">
      ...
      <article className="rounded-md border border-orange-200 bg-orange-50 p-4 xl:col-span-2">
